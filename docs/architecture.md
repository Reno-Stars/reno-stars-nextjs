...
3. Renders `<Navbar>` (receives `company`, `services`) and `<Footer>` (receives `company`, `socialLinks`, `services`, `areas`, `googleRating`) with this data as props
