...
- **Admin dashboard:** Auth-protected CRUD for all 12 content types at `/admin/` with unified House Stack UI for site/project management (sites, projects, blog, contacts, company, services, social links, service areas, gallery, trust badges, showroom, about sections, FAQs)
