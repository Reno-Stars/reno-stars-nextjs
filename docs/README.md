...
- **SEO-optimized:** Dynamic sitemap with per-entry timestamps, JSON-LD structured data (10 schema types including WebSite, FAQ), OG images with dimensions on all pages, database-driven SEO metadata, 50+ WordPress redirects, meta description truncation, security headers via proxy
