...
- **Admin dashboard:** Auth-protected CRUD for all 11 content types at `/admin/` (projects, blog, contacts, company, services, social links, service areas, gallery, trust badges, showroom, about sections)
