...
// CSS filter to tint black SVG <img> icons to the CURRENT GOLD above.
// Generated by scripts/generate-gold-icon-filter.ts and guarded by
// tests/unit/lib/gold-icon-filter.test.ts — if GOLD changes, re-run the
// generator and paste the new chain here or that test fails.
export const GOLD_ICON_FILTER = 'invert(54%) sepia(68%) saturate(589%) hue-rotate(2deg) brightness(54%) contrast(86%)';
