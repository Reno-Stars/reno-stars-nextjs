...
const ProjectDescriptionSchema = z.object({
  ...
  durationEn: z.string().default(''),
  durationZh: z.string().default(''),
  spaceTypeEn: z.enum(SPACE_TYPES.map((st) => st.en) as [string, ...string[]]).default('House'),
  descriptionEn: z.string(),
  descriptionZh: z.string(),
  challengeEn: z.string().default(''),
  challengeZh: z.string().default(''),
  solutionEn: z.string().default(''),
  solutionZh: z.string().default(''),
  badgeEn: z.string().default(''),
  badgeZh: z.string().default(''),
  excerptEn: z.string().default(''),
  excerptZh: z.string().default(''),
  metaTitleEn: z.string().default(''),
  metaTitleZh: z.string().default(''),
  metaDescriptionEn: z.string().default(''),
  metaDescriptionZh: z.string().default(''),
  focusKeywordEn: z.string().default(''),
  focusKeywordZh: z.string().default(''),
  seoKeywordsEn: z.string().default(''),
  seoKeywordsZh: z.string().default(''),
...
Field guidelines:
- serviceType: Detect the renovation type from the notes. If AVAILABLE_SERVICE_TYPES are provided, you MUST choose from that list or use null. Pick the most accurate match based on the scope of work described (e.g., 卫生间/浴室/shower/bath → "bathroom", 厨房/kitchen → "kitchen", 地下室/basement → "basement", 橱柜/cabinet → "cabinet", 办公室/商业/office/store → "commercial"). If no service type is a good match, return null.
