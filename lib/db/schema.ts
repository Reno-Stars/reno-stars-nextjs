...
// ============================================================================
// INVOICES — moved to standalone reno-stars-invoice-service (T22, 2026-05-27)
// ============================================================================
//
// The invoice schema (5 tables, 3 enums) was extracted to the standalone
// reno-stars-invoice-service and its own Postgres. The Drizzle DROP migration
// for Neon was generated alongside this commit. All invoice operations now
// route through the service via @/lib/clients/invoice.
