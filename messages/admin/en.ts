const en = {
  ...
  projects: {
    ...
    addScope: '+ Add Scope',
    houseSettings: 'House',
    linkedHouse: 'Linked House',
    noneStandalone: 'None (standalone project)',
    displayOrderInHouse: 'Display Order in House',
    serviceTypes: {
      kitchen: 'Kitchen',
      bathroom: 'Bathroom',
  ...
  testimonials: {
    ...
    deleteMessage: 'This will permanently delete the testimonial.',
