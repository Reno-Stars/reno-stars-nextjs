...
async function expandFaqs() {
  ...
  for (const f of rows) {
    ...
    if (ew<40||zw<40) {
      ...
      if (ew<40) ne+=' At Reno Stars, we ensure every aspect of your renovation is handled professionally. Our experienced team provides personalized solutions tailored to your needs and budget, backed by our comprehensive warranty and full insurance coverage.';
      if (zw<40) nz+=' Reno Stars确保装修的每个环节都由专业团队负责。我们根据您的需求和预算提供个性化方案，并提供全面的质保和保险保障。';
