...
const SITES_RAW: SiteData[] = [
  {
    ...
    // Note: Site-level images omitted to avoid duplicates with child projects
    imagePairs: [],
  },
  {
  ...
  },
  {
    ...
    // Note: Site-level images are minimal since child projects have detailed image pairs
    imagePairs: [
      {
...
const PROJECTS_RAW: ProjectData[] = [
  // ===== COQUITLAM WHITE SHAKER KITCHEN (Standalone) =====
  {
    ...
    imagePairs: [
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114131-1-scaled.jpg',
        beforeAltEn: 'Coquitlam kitchen before renovation',
        beforeAltZh: '高贵林厨房装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114429-mfrh-original-scaled.jpg',
        afterAltEn: 'White Shaker kitchen after renovation',
        afterAltZh: '白色摇门厨房装修后',
        titleEn: 'Kitchen Transformation',
        titleZh: '厨房改造',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114139-mfrh-original-scaled.jpg',
        beforeAltEn: 'Kitchen cabinets before',
        beforeAltZh: '厨房橱柜装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114441-mfrh-original-scaled.jpg',
        afterAltEn: 'Open concept kitchen view',
        afterAltZh: '开放式厨房视角',
        titleEn: 'Open Concept View',
        titleZh: '开放式视角',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114451.jpg',
        beforeAltEn: 'Kitchen island before',
        beforeAltZh: '厨房岛台装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114434-mfrh-original-scaled.jpg',
        afterAltEn: 'Kitchen backsplash detail',
        afterAltZh: '厨房后挡板细节',
        titleEn: 'Backsplash Detail',
        titleZh: '后挡板细节',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114139-1-scaled.jpg',
        beforeAltEn: 'Kitchen countertops before',
        beforeAltZh: '厨房台面装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114446.jpg',
        afterAltEn: 'White cabinets with modern hardware',
        afterAltZh: '配备现代五金的白色橱柜',
        titleEn: 'White Cabinets',
        titleZh: '白色橱柜',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114506.jpg',
        beforeAltEn: 'Kitchen storage before',
        beforeAltZh: '厨房储物装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2025/02/微信图片_20250228114455-mfrh-original-scaled.jpg',
        afterAltEn: 'Kitchen storage cabinets',
        afterAltZh: '厨房储物柜',
  ...
  // ===== SURREY WHITE TONED KITCHEN (Part of Surrey Whole House #3) =====
  {
    ...
    imagePairs: [
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/35.png',
        beforeAltEn: 'Surrey kitchen before renovation',
        beforeAltZh: '素里厨房装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/p3kiitchen-new.png',
        afterAltEn: 'Surrey white kitchen after',
        afterAltZh: '素里白色厨房装修后',
        titleEn: 'Kitchen Transformation',
        titleZh: '厨房改造',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/23-1.png',
        beforeAltEn: 'Kitchen appliances before',
        beforeAltZh: '厨房家电装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/36.png',
        afterAltEn: 'Modern appliances',
        afterAltZh: '现代家电',
        titleEn: 'Modern Appliances',
        titleZh: '现代家电',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/24-1.png',
        beforeAltEn: 'Kitchen lighting before',
        beforeAltZh: '厨房照明装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/37.png',
        afterAltEn: 'Kitchen lighting',
        afterAltZh: '厨房照明',
        titleEn: 'Kitchen Lighting',
        titleZh: '厨房照明',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/25-1.png',
        beforeAltEn: 'Kitchen countertops before',
        beforeAltZh: '厨房台面装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/38.png',
        afterAltEn: 'Kitchen countertops',
        afterAltZh: '厨房台面',
        titleEn: 'Countertops',
        titleZh: '台面',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/26-1.png',
        beforeAltEn: 'Kitchen overview before',
        beforeAltZh: '厨房全景装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/39.png',
        afterAltEn: 'Kitchen overview',
        afterAltZh: '厨房全景',
        titleEn: 'Kitchen Overview',
        titleZh: '厨房全景',
      },
    ],
    scopes: [
  ...
  // ===== DELTA TOWNHOUSE BATHROOM =====
  {
    ...
    imagePairs: [
      ...
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/36-1.png',
        beforeAltEn: 'Delta small bathroom before',
        beforeAltZh: 'Delta小浴室装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/43-3.png',
        afterAltEn: 'Delta small bathroom after',
        afterAltZh: 'Delta小浴室装修后',
        titleEn: 'Small Bathroom',
        titleZh: '小浴室',
      },
    ],
    scopes: [
  ...
  // ===== WEST VANCOUVER FLOATING BATHROOM VANITY =====
  {
    ...
    imagePairs: [
      ...
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/43.png',
        beforeAltEn: 'Vanity area before',
        beforeAltZh: '洗手台区域装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/p4-bath-wash-after.png',
        afterAltEn: 'Floating vanity detail',
        afterAltZh: '悬浮洗手台细节',
        titleEn: 'Floating Vanity',
        titleZh: '悬浮洗手台',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/42.png',
        beforeAltEn: 'Bathroom fixtures before',
        beforeAltZh: '浴室设备装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/44.png',
        afterAltEn: 'Bathroom fixtures',
        afterAltZh: '浴室设备',
        titleEn: 'Fixtures',
        titleZh: '设备',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/46.png',
        beforeAltEn: 'Bathroom overview before',
        beforeAltZh: '浴室全景装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/p4-bath-after-2.png',
        afterAltEn: 'Bathroom overview',
        afterAltZh: '浴室全景',
        titleEn: 'Bathroom Overview',
        titleZh: '浴室全景',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/p4-bath-before-2.png',
        beforeAltEn: 'Secondary bathroom before',
        beforeAltZh: '第二浴室装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/07/64-project-photos.jpg',
        afterAltEn: 'Secondary bathroom after',
        afterAltZh: '第二浴室装修后',
        titleEn: 'Secondary Bathroom',
        titleZh: '第二浴室',
      },
    ],
    scopes: [
  ...
  // ===== RICHMOND KITCHEN REMODEL (Part of Richmond Family Home) =====
  {
    ...
    imagePairs: [
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/10-1.png',
      ...
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/06/微信图片_20221107101825.jpg',
        beforeAltEn: 'Living room before',
        beforeAltZh: '客厅装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/04/11-1.png',
        afterAltEn: 'Dining area',
        afterAltZh: '餐厅区',
    ...
    imagePairs: [
      {
        ...
        afterAltEn: 'First floor bathroom after',
        afterAltZh: '一楼卫生间装修后',
        titleEn: 'First Floor Bathroom',
        titleZh: '一楼卫生间',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2024/06/二楼小卫生间1.jpg',
        beforeAltEn: 'Second floor small bathroom before',
        beforeAltZh: '二楼小卫生间装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2024/06/二楼小卫生间2-1-scaled.jpg',
        afterAltEn: 'Second floor small bathroom after',
        afterAltZh: '二楼小卫生间装修后',
        titleEn: 'Second Floor Small Bathroom',
        titleZh: '二楼小卫生间',
      },
    ],
    scopes: [
  ...
  // ===== WHOLE HOUSE FROM KITCHEN TO BEDROOM =====
  {
    ...
    imagePairs: [
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2025/03/kitchen-renovation-before.jpeg',
        beforeAltEn: 'Kitchen before renovation',
        beforeAltZh: '厨房装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2025/03/contemporary-kitchen-remodel-marble-island-and-wood-cabinets.jpg',
        afterAltEn: 'Contemporary kitchen with marble island',
        afterAltZh: '带大理石岛台的现代厨房',
        titleEn: 'Kitchen Transformation',
        titleZh: '厨房改造',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2025/03/living-room-renovation-before.jpeg',
        beforeAltEn: 'Living room before renovation',
        beforeAltZh: '客厅装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2025/03/whole-house-renovation-open-living-and-dining-space.jpg',
        afterAltEn: 'Open living and dining space',
        afterAltZh: '开放式客厅和餐厅',
        titleEn: 'Living & Dining',
        titleZh: '客厅和餐厅',
      },
      {
        beforeUrl: 'https://reno-stars.com/wp-content/uploads/2025/03/bathroom-renovation-before.jpg',
        beforeAltEn: 'Bathroom before renovation',
        beforeAltZh: '浴室装修前',
        afterUrl: 'https://reno-stars.com/wp-content/uploads/2025/03/sleek-modern-bathroom-with-ambient-lighting.jpg',
        afterAltEn: 'Modern bathroom with ambient lighting',
        afterAltZh: '带氛围照明的现代浴室',
        titleEn: 'Bathroom',
        titleZh: '浴室',
      },
    ],
