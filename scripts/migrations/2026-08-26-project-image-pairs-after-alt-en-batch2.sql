-- Migration: project_image_pairs after_alt_text_en (batch 2)
-- Status: NOT APPLIED — needs human to run
-- Coverage: 38 rows where after_alt_text_en IS NULL (remaining after batch 1 of 58)
...
-- Excludes: 58 IDs already covered by 2026-08-24-project-image-pairs-after-alt-en.sql
