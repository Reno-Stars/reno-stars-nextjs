-- Migration: project_image_pairs beforeAltTextEn from titleEn
-- Rows: 58 published project_image_pairs missing before_alt_text_en
-- Source: titleEn field on project_image_pairs
-- NOT APPLIED — requires human execution after PR merge
-- Extracted from: scripts/migrations/2026-08-23-project-image-pairs-before-alt-zh.sql
