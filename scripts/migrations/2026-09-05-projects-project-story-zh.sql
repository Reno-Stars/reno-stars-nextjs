-- Migration: projects project_story_zh fallback — 56 rows with NULL zh
-- Strategy: copy project_story (English) to project_story_zh as fallback
--   to keep field non-NULL. Human review recommended for proper Chinese.
-- Table: projects
-- Column: project_story_zh
-- NOT APPLIED — needs human to run after review

UPDATE projects
SET project_story_zh = project_story
