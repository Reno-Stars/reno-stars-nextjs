  ...
  return (
    <section id="showroom" aria-labelledby="showroom-title" className="py-14 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: NAVY }}>
      <div className="max-w-4xl mx-auto text-center">
        <Image src={company.logo} alt={company.name} width={180} height={40} loading="lazy" className="h-10 w-auto object-contain mx-auto mb-5 rounded-md bg-white/95 px-3 py-1" style={{ boxShadow: '8px 8px 20px rgba(0,0,0,0.5), -8px -8px 20px rgba(255,255,255,0.12), 0 0 30px rgba(255,255,255,0.06)' }} />
        <h2 id="showroom-title" className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 text-white">{t.title}</h2>
        ...
        <Link href="/contact"
          ...
          style={{ backgroundColor: GOLD, boxShadow: `8px 8px 20px rgba(0,0,0,0.5), -8px -8px 20px rgba(255,255,255,0.12), 0 0 30px rgba(200,146,42,0.25)` }}
        >
          {t.bookAppointment}
        </Link>
      </div>
