                ...
                <div className="flex items-start gap-4">
                  {service.icon && (
                    ...
                    >
                      ...
                      <img src={service.icon} alt={pickLocale(service.title, locale)} loading="lazy" decoding="async" fetchPriority="low" className="w-5 h-5" style={{ filter: GOLD_ICON_FILTER }} />
                    </div>
                  )}
