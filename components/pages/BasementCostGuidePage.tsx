...
export default function BasementCostGuidePage({ locale, projects, phone, share }: BasementCostGuidePageProps) {
  ...
  const costTiers = [
    { key: 'budget', icon: DollarSign, accent: STEP_GREEN, accentLight: STEP_GREEN_LIGHT, range: formatPriceTier('basement', 'budget', 'long') },
    { key: 'midRange', icon: Home, accent: STEP_TEAL, accentLight: STEP_TEAL_LIGHT, range: formatPriceTier('basement', 'mid', 'long') },
    { key: 'highEnd', icon: TrendingUp, accent: STEP_ORANGE, accentLight: STEP_ORANGE_LIGHT, range: formatPriceTier('basement', 'high', 'long') },
  ];
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: SURFACE }}>
        <div className="max-w-4xl mx-auto">
          ...
          <ShareBar
            ...
            context={share}
            contentType="guide"
            itemId="basement-renovation-cost-vancouver"
          />
        </div>
      </section>
