...
export default function WholeHouseCostGuidePage({ locale, projects, phone, share }: WholeHouseCostGuidePageProps) {
  ...
  const costTiers = [
    { key: 'budget', icon: DollarSign, accent: STEP_GREEN, accentLight: STEP_GREEN_LIGHT, range: formatPriceTier('whole-house', 'budget', 'long') },
    { key: 'midRange', icon: Home, accent: STEP_TEAL, accentLight: STEP_TEAL_LIGHT, range: formatPriceTier('whole-house', 'mid', 'long') },
    { key: 'highEnd', icon: TrendingUp, accent: STEP_ORANGE, accentLight: STEP_ORANGE_LIGHT, range: formatPriceTier('whole-house', 'high', 'long') },
  ];
  ...
  return (
    <main>
      ...
      <section className="py-14 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: SURFACE_ALT }}>
        <div className="max-w-4xl mx-auto">
          ...
          <ShareBar
            ...
            context={share}
            contentType="guide"
            itemId="whole-house-renovation-cost-vancouver"
          />
        </div>
      </section>
      ...
      {/* /whole-house-renovation-near-me/ inbound — extends the /X-renovation-
      ...
      <section className="py-8 px-4 sm:px-6 lg:px-8" style={{ backgroundColor: SURFACE }}>
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-sm" style={{ color: TEXT_MID }}>
            Searching &ldquo;whole-house renovation near me&rdquo;?{' '}
            <Link
              href="/whole-house-renovation-near-me"
