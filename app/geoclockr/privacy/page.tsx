...
export const metadata: Metadata = {
  title: 'GeoClockr Privacy Policy | Reno Stars',
  description:
    'How GeoClockr collects, uses, and shares location, work records, and media — including background location used for automatic clock in and out.',
...
export default function GeoClockrPrivacyPage() {
  return (
    <main
      id="main-content"
    ...
    >
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-base leading-relaxed" style={{ color: TEXT_MID }}>
          <p>
            GeoClockr (&ldquo;the app&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;) is a workforce
            time-tracking app operated by Reno Stars (&ldquo;the operator&rdquo;). GeoClockr is used
          ...
          >
            <p>
              <strong style={{ color: NAVY }}>
                Please read this first — GeoClockr is an employer tool.
              </strong>{' '}
              If you use GeoClockr, your employer has an account and can see the location, clock
              in/out times, timesheets, photos, and job-site activity that the app records about you
              while you are on the clock or near an assigned job site. GeoClockr collects location{' '}
          ...
          <Section title="Information we collect">
            ...
            <p className="mb-3">
              ...
              With your permission, GeoClockr collects your device&rsquo;s precise and approximate
              location:
            </p>
            ...
            <p className="mb-3">
              ...
              GeoClockr uses your device&rsquo;s activity-recognition sensor to detect whether you
          ...
          <Section title="Who we share information with">
            <p className="mb-3">
              ...
              job-site activity through their GeoClockr admin tools. GeoClockr is a tool your
          ...
          <Section title="Your choices">
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                delete your personal data, contact your employer&rsquo;s GeoClockr administrator or
          ...
          <Section title="Children">
            <p>
              GeoClockr is a workplace app intended for adults in an employment relationship. It is
          ...
          <Section title="International users">
            <p>
              ...
              By using GeoClockr you consent to this transfer.
            </p>
          </Section>
          ...
          <Section title="Contact">
            <p className="mb-1">
              <strong style={{ color: NAVY }}>Reno Stars — GeoClockr</strong>
            </p>
            <p className="mb-1">
              Email:{' '}
