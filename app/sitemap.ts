...
// NOTE: non-www → www redirect (Cloudflare rules). Crawlers hitting
// https://reno-stars.com/sitemap.xml get a 301 to
// https://www.reno-stars.com/sitemap.xml which is the canonical. The
// NEXT_PUBLIC_BASE_URL (or its fallback) must always be the canonical
// www form to match what this route returns.
//
// Sitemap traffic is crawler-only and low-volume, so the per-request DB
