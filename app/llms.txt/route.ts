...
export async function GET(): Promise<Response> {
  ...
  const keyPagesBlock = [
    ...
    `- [Projects (${COMPANY_STATS.projectsCompleted})](${en}/projects/)`,
  ...
  const faqBlock = [
    ...
    `Kitchen renovations in Vancouver typically range from $15,000 to $72,000+ based on completed ${SITE_NAME} kitchen renovation projects. Basic refresh runs $15K-$30K, mid-range $30K-$50K, and full custom $50K-$72K+. Pricing varies by cabinetry, countertops, appliances, and whether the layout changes.`,
    '',
