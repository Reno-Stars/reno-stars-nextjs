...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    alternates: buildAlternates('/guides/commercial-renovation-cost-vancouver/', locale, INDEXABLE_LEAF_LOCALES),
    openGraph: {
      title: t('title'),
      description: t('description'),
...
export default async function Page({ params }: PageProps) {
  ...
  const shareUrl = buildAlternates('/guides/commercial-renovation-cost-vancouver/', locale).canonical;
  const ogImage = buildOgImageUrl(mt('title'), mt('description'));

  return (
    <ClientMessages ns={['cta', 'guides.commercialCost', 'share']}>
