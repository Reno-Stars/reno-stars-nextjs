...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: 'metadata.guides.basementSuiteCost' });
  ...
  return {
    ...
    alternates: buildAlternates('/guides/basement-suite-cost-vancouver/', locale, INDEXABLE_LEAF_LOCALES),
    openGraph: {
      title: t('title'),
      description: t('description'),
      url: `${baseUrl}/${locale}/guides/basement-suite-cost-vancouver/`,
      siteName: SITE_NAME,
...
export default async function Page({ params }: PageProps) {
  ...
  const breadcrumbs = [
    ...
    { name: t('breadcrumb'), url: `/${locale}/guides/basement-suite-cost-vancouver/` },
  ];
  ...
  return (
    <ClientMessages ns={['cta', 'guides.basementSuiteCost', 'share']}>
