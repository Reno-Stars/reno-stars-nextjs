...
import KitchenCabinetGuidePage from '@/components/pages/KitchenCabinetGuidePage';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: 'metadata.guides.kitchenCabinet' });
  ...
  return {
    ...
    alternates: buildAlternates('/guides/vancouver-kitchen-cabinet-renovation/', locale, INDEXABLE_LEAF_LOCALES),
    openGraph: {
      title: t('title'),
      description: t('description'),
      url: `${baseUrl}/${locale}/guides/vancouver-kitchen-cabinet-renovation/`,
      siteName: SITE_NAME,
...
export default async function Page({ params }: PageProps) {
  ...
  const [nav, t, mt, company] = await Promise.all([
    ...
    getTranslations({ locale, namespace: 'guides.kitchenCabinet' }),
    getTranslations({ locale, namespace: 'metadata.guides.kitchenCabinet' }),
    getCompanyFromDb(),
  ]);
  ...
  const breadcrumbs = [
    ...
    { name: t('breadcrumb'), url: `/${locale}/guides/vancouver-kitchen-cabinet-renovation/` },
  ];
  ...
  const shareUrl = buildAlternates('/guides/vancouver-kitchen-cabinet-renovation/', locale).canonical;
  ...
  return (
    <ClientMessages ns={['cta', 'guides.kitchenCabinet', 'guides.relatedGuides', 'share']}>
      ...
      <ArticleSchema
        ...
        url={`/${locale}/guides/vancouver-kitchen-cabinet-renovation/`}
